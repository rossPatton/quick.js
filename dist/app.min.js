...
var query = function query(sel) {
  ...
  var key = '' + this.options.parent.nodeName + ':' + sel;

  if (this.options.bust === true || typeof this.cache[key] === 'undefined') {

    this.cache[key] = this.toArray(this.options.parent.querySelectorAll(sel));
  }
...
// initialize the app
var App = (function (input, options) {
