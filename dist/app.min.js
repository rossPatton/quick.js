 ...
 */
var query = function query(sel, options) {
	...
	var key = '' + options.parent.nodeName + ':' + sel;

	if (options.bust === true || typeof this.cache[key] === 'undefined') {

		this.cache[key] = this.toArray(options.parent.querySelectorAll(sel));
	}

	console.dir(this.cache[key]);
